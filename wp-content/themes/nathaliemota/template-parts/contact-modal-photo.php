<div class="modal-overlay" id="contactModalPhoto">
                ...
                <form action="#" method="post">
                    <div class="column-container">
                        <div class="col-1">
                            ...
                            <?php
                            // Récupérer la référence ACF
                            $reference_photo = get_field('reference_photo');
                            ?>
                            <input type="text" id="photo-ref" name="photo-ref" value="<?php echo esc_attr($reference_photo); ?>" readonly>
                        </div>
                        <div class="col-2">
